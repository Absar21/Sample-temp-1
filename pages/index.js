...
export default function Home() {
  ...
  <title>Aiobc temp</title>
  {/* Favicon*/}
  <link rel="icon" type="image/x-icon" href="assets/aioibc.png" />
  ...
  <nav className="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div className="container">
      <a className="navbar-brand" href="#page-top">
        <img src="assets/img/aiobc.png" alt="..." width="50px" height="500px"/>
      </a>
      <button
  ...
  <header className="masthead">
    <div className="container">
      <div className="masthead-subheading">Welcome To Our Aiobc!</div>
  ...
  <section className="page-section" id="contact">
    <div className="container">
      <div className="text-center">
      <a className="nav-link" href="https://aiobc.io/">
